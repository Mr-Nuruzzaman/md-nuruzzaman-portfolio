...
export function Section({
  ...
  const header = (eyebrow || heading) && (
    <header className="mb-12 md:mb-16">
      ...
      {heading && <h2 className="mt-3 text-h2 font-heading font-bold text-content">{heading}</h2>}
    </header>
  );
  ...
  return (
    <section id={id} className={cn('relative scroll-mt-24 py-24 md:py-32', className)} {...props}>
